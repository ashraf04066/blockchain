...
'''
This method performs all operations required to extract features.
...
for each address in the darknet data of that day, it matches the price with all prices of all addresses
of the same day from the graph data. If it matches, then it's features are written intom csv writer as a bad address.
